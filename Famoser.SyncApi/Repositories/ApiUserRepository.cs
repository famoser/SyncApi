...
{
    public class ApiUserRepository<TUser> : BaseHelper, IApiUserRepository<TUser>
        where TUser : IUserModel
    {
        private readonly AuthApiClient _authApiClient;
        private readonly IApiStorageService _apiStorageService;
        private readonly IApiConfigurationService _apiConfigurationService;
        private readonly IManager<TUser> _manager;

        public ApiUserRepository(IApiConfigurationService apiConfigurationService, IApiStorageService apiStorageService)
        {
        ...
        public async Task<bool> SyncAsync()
        {
            ...
            else if (_user.ModelInformation.PendingAction == PendingAction.Read)
            {
                ...
                {
                    _manager.Set(JsonConvert.DeserializeObject<TUser>(resp.UserEntity.Content));
                }
                else
                    return false;
            }
